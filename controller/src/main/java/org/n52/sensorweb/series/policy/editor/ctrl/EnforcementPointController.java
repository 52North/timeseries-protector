 ...
 */
@Controller
public class EnforcementPointController {

    private EnforcementPointService enforcementPointService;

    @RequestMapping(value = "/enforcements", produces = "application/json", method = RequestMethod.GET)
    public List<EnforcementPoint> getEnforcementPoints() {
        return enforcementPointService.getEnforcementPoints();
    }
    ...
    public void setEnforcementPointService(EnforcementPointService enforcementPointController) {
        this.enforcementPointService = enforcementPointController;
    }
