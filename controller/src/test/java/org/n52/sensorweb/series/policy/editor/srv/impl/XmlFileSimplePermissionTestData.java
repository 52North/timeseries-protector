 ...
 */
public class XmlFileSimplePermissionTestData {
    ...
    public XmlFileSimplePermissionTestData() throws FileNotFoundException {
        provider = new SimplePermissionFileProvider();
        String path = FileUtils.getAbsolutePathFor("/files");
        String file = path.concat(File.separator).concat("test-permissions.xml");
